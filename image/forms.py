...
class ImageRequestForm(forms.ModelForm):
    ...
    latitude = forms.DecimalField(required=False, max_digits=20, decimal_places=17,widget=forms.HiddenInput())
    longitude = forms.DecimalField(required=False, max_digits=20, decimal_places=17,widget=forms.HiddenInput())
